					...
					<Flex
						...
						<Center>
							<ButtonBox
								...
								subtext='Buy Now. pay Over Time.'
							/>
						</Center>
						<ProceedButton
							text='PROCEED TO CHECKOUT'
							subtText='First time tax-exempt order?'
							subSubText='Click PROCEED TO CHECKOUT to create an account'
						/>
					</Flex>
				</Stack>
				<Box mt={"5"}>
					<Flex
						...
						<Text flex={0.5}>ITEM</Text>
						<Text>PICK UP OR DILIVERY</Text>
						<Text>QUANTITY</Text>
						<Text>PRICE</Text>
					</Flex>
					{total ? (
